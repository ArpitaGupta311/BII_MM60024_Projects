...
- [Final Projects for MM60024 : Biomedical Imaging Informatics](#final-projects-for-MM60024--Biomedical-Imaging-Informatics)
  ...
  - [Projects](#projects)
    ...
    - [Project 9 : Multiorgan Segmentation Using the AbdomenAtlas Mini Dataset](#Project-9--Multiorgan-Segmentation-Using-the-AbdomenAtlas-Mini-Dataset)
...
| Group 8 & 12 | [Project 8 : Explainable Survival Prediction of Liver Cirrhosis Patients](#Project-8--Explainable-Survival-Prediction-of-Liver-Cirrhosis-Patients) | _ |
...
1. The objective of this project is to develop a machine learning-based system for early prediction of CHD using patient clinical and lifestyle data. The dataset is located in the `data/Heart_disease` directory.
...
1. The dataset is located in the `data/MultimodalFusion` directory and consists of paired Magnetic Resonance Imaging (MRI) and Single Photon Emission Computed Tomography (SPECT) brain images collected from publicly available medical imaging repositories or clinical datasets. Each pair corresponds to the same patient and registered.
